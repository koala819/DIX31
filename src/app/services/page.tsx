      ...
      <div className=''>
        ...
        <div className='flex items-center  justify-center px-2 space-x-8 my-16'>
          ...
          <section className='px-6 py-4 transition-colors duration-200 transform bg-gray-700 rounded-lg dark:bg-blue-800 dark:hover:bg-blue-900'>
            <p className='text-lg font-medium text-gray-100'>Site Dynamique</p>
            ...
            <p className='mt-4 text-gray-300'>
              Un site interactif, mariez design et fonctionnalités de manière
              harmonieuse.
            </p>
            ...
            <div className='mt-8 space-y-8'>
              ...
              <div className='flex items-center'>
                ...
                <span className='mx-4 text-gray-300'>Partenariat Actif</span>
              </div>
            </div>

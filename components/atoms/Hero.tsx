              ...
              {profileItems.map((item, index) => (
                ...
                >
                  <div className="flex justify-between items-center lg:flex-col lg:items-start py-2">
                    <div className="text-lg font-bold text-gray-800 dark:text-gray-200 order-2 lg:order-1 lg:mb-1">
                      {item.value}
                    </div>
                    <div className="text-sm text-gray-500 dark:text-gray-400 order-1 lg:order-2">
                      {item.label}
                    </div>
                  </div>
                </div>
